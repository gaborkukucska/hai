...
*   Unless you've received other specific tasks, follow a phased implementation as outlined in the `helperfiles/PROJECT_STATUS.toml` file.
*   Maintain `README.md`, `helperfiles/PROJECT_STATUS.toml` (update status) and `helperfiles/FUNCTIONS_INDEX.md`, updating them at the end of every development run.
...
*   Measure in predicted "generation token length" instead of any units of "time" when estimating the length of planned work, as that is more representative of how "long" a planned task will take.
